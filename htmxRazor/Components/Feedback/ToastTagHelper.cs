...
/// <summary>
/// Renders an individual toast notification with variant-appropriate icon,
/// optional close button, and auto-dismiss support.
/// Typically rendered inside an <c>&lt;rhx-toast-container&gt;</c>.
/// </summary>
/// <example>
/// <code>
/// &lt;rhx-toast rhx-variant="success" rhx-duration="5000"&gt;
///     Item saved successfully!
/// &lt;/rhx-toast&gt;
/// </code>
/// </example>
[HtmlTargetElement("rhx-toast")]
public class ToastTagHelper : htmxRazorTagHelperBase
{
    /// <inheritdoc/>
    protected override string BlockName => "toast";
    ...
    /// <summary>
    /// Auto-dismiss duration in milliseconds. Overrides the container default.
    /// 0 = no auto-dismiss.
    /// </summary>
    ...
    public ToastTagHelper(IUrlHelperFactory urlHelperFactory) : base(urlHelperFactory) { }
